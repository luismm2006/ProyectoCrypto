...
export const routes: Routes = [
    ...
    { path: 'missions/:id', loadComponent: () => import('./pages/missionsId/missionsId').then(m => m.Missions), canActivate : [guardAuth] },

    { path: "add-mission", loadComponent: () => import('./pages/new-mission/new-mission').then(m => m.NewMission), canActivate : [guardAdmin]},
    { path: "edit-mission/:id", loadComponent: () => import('./pages/new-mission/new-mission').then(m => m.NewMission), canActivate : [guardAdmin]},
